const Intro = () => {
  return (
    <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-6 md:py-12 lg:py-18">
      ...
      <span className="max-w-[750px] text-center text-lg !font-normal sm:text-xl">
      ...
      <div className="flex w-full items-center justify-center space-x-4 pt-2">
        <a
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center rounded-lg bg-[#f4f4f5] px-3 py-1 text-sm font-medium hover:bg-[#e5e5e5]"
